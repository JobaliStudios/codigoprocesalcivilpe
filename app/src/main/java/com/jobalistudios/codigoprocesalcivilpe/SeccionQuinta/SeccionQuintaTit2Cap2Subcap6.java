...
public class SeccionQuintaTit2Cap2Subcap6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seccion_quinta_tit2_cap2_subcap6);
    ...
    private void performSearch(String query) {
        ...
        SpannableString spannable = new SpannableString(getString(R.string.seccionquintatit2cap2subcap6));
