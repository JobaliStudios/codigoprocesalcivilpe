...
public class SeccionPrimeraTit2Cap2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seccion_primera_tit2_cap2);
    ...
    private void performSearch(String query) {
        ...
        SpannableString spannable = new SpannableString(getString(R.string.seccionprimeratit2cap2txt));
