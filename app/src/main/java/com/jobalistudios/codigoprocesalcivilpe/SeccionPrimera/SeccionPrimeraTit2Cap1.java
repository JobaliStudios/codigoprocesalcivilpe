...
public class SeccionPrimeraTit2Cap1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seccion_primera_tit2_cap1);
    ...
    private void performSearch(String query) {
        ...
        SpannableString spannable = new SpannableString(getString(R.string.seccionprimeratit2cap1txt));
