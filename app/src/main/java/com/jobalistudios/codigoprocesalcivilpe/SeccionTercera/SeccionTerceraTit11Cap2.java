...
public class SeccionTerceraTit11Cap2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seccion_tercera_tit11_cap2);
// Inicialización de vistas
    ...
    private void performSearch(String query) {
        ...
        SpannableString spannable = new SpannableString(getString(R.string.seccionterceratit11cap2));
