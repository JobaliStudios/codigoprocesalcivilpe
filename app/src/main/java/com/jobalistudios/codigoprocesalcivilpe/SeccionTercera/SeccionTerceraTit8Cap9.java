...
public class SeccionTerceraTit8Cap9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seccion_tercera_tit8_cap9);
    ...
    private void performSearch(String query) {
        ...
        SpannableString spannable = new SpannableString(getString(R.string.seccionterceratit8cap9));
