...
public class FavoriteItem {
    ...
    public FavoriteItem(String id, String title, String subtitle, String type, String activityClassName) {
        this.id = id;
        this.title = title;
    ...
    public JSONObject toJson() throws JSONException {
        ...
        object.put(KEY_ACTIVITY, activityClassName);
        return object;
    }
